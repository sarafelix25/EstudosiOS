...
//  Tinder
//
//  Created by Sara Batista dos Santos Felix (P) on 02/03/22.
//
...
class UserService {
    ...
    let users: [User] = [
        ...
        User(id: 108, name: "Sandra Souza", age: 24, match: true, phrase: "Fotos sem camisa não me impressionam", image: "pessoa-8"),
